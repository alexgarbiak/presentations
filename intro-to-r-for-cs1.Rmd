...
- *Given the dataset "abc"*:

1. *Fit a generalised linear model to the dataset using a Poisson distribution*
...
Therefore $y = 2.1 + 3.2x_1 + 0.4x_2$ where $x_1$ is the "abc" variable and $x_2$ is the "def" variable
